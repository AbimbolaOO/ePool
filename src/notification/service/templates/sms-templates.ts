export class SMSTemplates {
  static emailVerificationTemplate(otp: string) {
    return `Hi,\nTo verify your ePool account please enter the pin: ${otp}. It is valid for the next 10 minutes`;
  }
  ...
  static airtimePurchaseSuccessTemplate(
    ...
    return `Your airtime purchase of ${amount} for ${phone} was successful. ${message}. Thank you for using ePool.`;
  }
  ...
  static dataPurchaseSuccessTemplate(
    ...
    return `Your data purchase of ${amount} for ${phone} was successful. ${message}. Thank you for using ePool.`;
  }
  ...
  static stockCompletionUpdateSuccessTemplate(amount: number, email: string) {
    return `Your order for ${amount} asset has been completed successfully. Thank you for choosing ePool. For inquiries, contact ${email}`;
  }

  static passwordResetTemplate(otp: string) {
    return `Hi,\nTo reset your ePool account password please enter the pin: ${otp}. It is valid for the next 10 minutes`;
  }
  ...
  static sendPhoneNumberVerificationSMS(otp: string) {
    return `Hi,\nYour ePool Verification Pin is ${otp}. It is valid for the next 10 minutes`;
  }

  static userSignupWelcomeSMS() {
    return `Hi there,\nWelcome to ePool we are happy to have you onboard. Powered By ePool
`;
  }
}
